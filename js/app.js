(() => {
    ...
    function initSliders() {
        if (document.querySelector(".materials")) new core(".materials__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.3,
        ...
        if (document.querySelector(".testimonials")) new core(".slider-testimonials__body", {
    ...
    if (contactForm) sendFormBtn.addEventListener("click", (e => {
        e.preventDefault();
    }));
    window["FLS"] = true;
    isWebp();
